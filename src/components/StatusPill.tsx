const STATUS_STYLES: Record<string, string> = {
  ...
  'En análisis': 'bg-ember-tint text-ember border-ember/25',
  'En tratamiento': 'bg-ember-tint text-ember border-ember/25',
  Respondida: 'bg-ember-tint text-ember border-ember/25',
